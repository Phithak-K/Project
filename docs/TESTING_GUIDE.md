...
2. **ขั้นตอนการทำงานของขนส่ง (Driver):**
   ...
   * เมื่อส่งพัสดุถึงมือผู้รับ ให้คลิกเลือกวิธีชำระเงิน (สแกน QR หรือ รับเงินสด) จากนั้นกดปุ่ม "จำลองถ่ายรูป (Mock POD)" เพื่อจำลองการแนบหลักฐาน แล้วกด **"จัดส่งสำเร็จ"** (`DELIVERED`)
