...
export default function DriverDashboardPage() {
  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      try {
        const res = await fetch('/api/proxy/orders/stats/driver');
        if (res.ok) {
    ...
    <div className="sp-page">
      ...
      <main style={{ maxWidth: '520px', margin: '0 auto', padding: '2rem 1.25rem' }}>
        ...
        <div className="sp-stagger" style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div className="sp-card" style={{ borderLeft: '3px solid var(--brand-500)' }}>
          ...
          <div className="sp-card" style={{ borderLeft: '3px solid oklch(65% 0.12 220)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
            <div className="sp-card">
              ...
              <div className="sp-stat-number" style={{ fontSize: '2rem', color: 'var(--n-900)', marginTop: '0.5rem' }}>{stats?.activeOrders || 0}</div>
            ...
            <div className="sp-card">
              ...
              <div className="sp-stat-number" style={{ fontSize: '2rem', color: 'var(--n-900)', marginTop: '0.5rem' }}>{stats?.completedTrips || 0}</div>
              <div className="sp-caps" style={{ color: 'var(--n-700)', marginTop: '0.25rem' }}>ออเดอร์</div>
            </div>
          </div>
