      ...
      <div className="sp-auth-form-panel">
        <div style={{ maxWidth: '420px', width: '100%' }}>
          ...
          <div style={{ marginBottom: '1.5rem' }}>
             <button onClick={() => loginWithGoogle()} type="button" className="sp-btn-ghost sp-btn-full" style={{ border: '1px solid var(--n-200)', color: 'var(--n-700)', padding: '0.75rem', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }} title="Google">
